      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-accent mb-4">TapHair</h3>
            <p className="text-gray-300 mb-4">
              La plateforme qui connecte les clients avec les meilleurs coiffeurs. Réservez vos rendez-vous en quelques clics, que ce soit en salon ou à domicile.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/search" className="text-gray-300 hover:text-accent transition-colors">
