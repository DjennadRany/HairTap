...
import { FaTruck, FaStore, FaCreditCard, FaSpinner } from 'react-icons/fa';
import Modal from './ui/Modal';
import { paymentService, OrderData } from '../services/api/payments';
    ...
    <Modal isOpen={open} onClose={onClose} title="Paiement du produit">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-gray-700">Informations de contact</h4>
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="border-t pt-2 flex justify-between font-semibold">
              <span>Total</span>
              <span>
                {formData.deliveryOption === 'delivery' ? totalPrice + 5 : totalPrice}€
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3 pt-4">
          ...
          >
            {isProcessing ? (
              ...
              <>
                <FaCreditCard />
                Payer {formData.deliveryOption === 'delivery' ? totalPrice + 5 : totalPrice}€
              </>
            )}
          </button>
        </div>
