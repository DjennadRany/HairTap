...
import { useCoiffeurServices } from '../../../hooks/useCoiffeurServices';
...
const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  // ✅ Utiliser le hook useCoiffeurServices pour le cache Redux
  ...
  const fetchServices = async () => {
    try {
      // ✅ Utiliser le cache Redux via le hook
      const servicesData = await fetchCoiffeurServices(false);
      if (servicesData) {
